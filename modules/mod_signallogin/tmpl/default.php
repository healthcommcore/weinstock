...
if ($params->get('module_theme') != "none") :
...
<?php else : ?>
    ...
    <?php if($params->get('horizontal')) : ?>
        ...
        <form action="<?php echo JRoute::_( 'index.php', true, $params->get('usesecure')); ?>" method="post" name="login" id="form-login" >
            <div id="sl_username">
                <input id="mod_login_username" type="text" name="username" alt="username" size="<?php echo $params->get('name_lenght'); ?>" value="<?php echo JText::_('Username'); ?>" onfocus="if (this.value=='<?php echo JText::_('Username'); ?>') this.value=''" onblur="if(this.value=='') { this.value='<?php echo JText::_('Username'); ?>'; return false; }" />
			</div>
            <div id="sl_pass">
                <input id="mod_login_password" type="password" name="passwd" alt="password" size="<?php echo $params->get('pass_lenght'); ?>" value="<?php echo JText::_('Password'); ?>" onfocus="if (this.value=='<?php echo JText::_('Password'); ?>') this.value=''" onblur="if(this.value=='') { this.value='<?php echo JText::_('Password'); ?>'; return false; }" />
			</div>
            <?php
            ...
            <?php if($params->get('show_lostname')) : ?>
                    <div id="sl_lostname"><a href="<?php echo JRoute::_( 'index.php?option=com_user&view=remind' ); ?>">
